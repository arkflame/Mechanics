...
public class CobblestoneCMD implements CommandExecutor {
  ...
  public CobblestoneCMD(GameMechanicsManager gameMechanicsManager) {
  ...
  public boolean onCommand(CommandSender commandSender, Command command, String s, String[] strings) {
    if (commandSender instanceof Player) {
      ...
      if (gameMechanicsPlayer.isCobblestone()) {
        commandSender.sendMessage(ChatColor.translateAlternateColorCodes('&', "&aActivaste el filtro de cobblestone!"));
      } else {
        commandSender
            .sendMessage(ChatColor.translateAlternateColorCodes('&', "&cDesactivaste el filtro de cobblestone!"));
      }
    } else {
      commandSender
